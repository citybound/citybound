...
fn path_intersecting_close_before_curved_segment_start() {
    ...
    assert_eq!(
        (
            ...
            &Path::new(vec![
                Segment::line(P2::new(1.0 - TINY_BIT, 1.0), P2::new(1.0 - TINY_BIT, -1.0)).unwrap(),
            ]).unwrap(),
        ).intersect(),
        IntersectionResult::Intersecting(vec![Intersection {
...
fn path_intersecting_close_after_curved_segment_start() {
    ...
    assert_eq!(
        (
            &Path::new(vec![
                Segment::line(P2::new(0.0, 0.0), P2::new(100.0, 0.0)).unwrap(),
                Segment::arc_with_direction(
                    P2::new(100.0, 0.0),
                    V2::new(1.0, 0.0),
                    P2::new(200.0, 100.0),
        ...
        (
            ...
            &Path::new(vec![
                ...
                Segment::line(P2::new(1.0 - TINY_BIT, -1.0), P2::new(2.0 - TINY_BIT, -1.0))
                    .unwrap(),
                Segment::line(P2::new(2.0 - TINY_BIT, -1.0), P2::new(2.0 - TINY_BIT, 1.0)).unwrap(),
                Segment::line(P2::new(2.0 - TINY_BIT, 1.0), P2::new(1.0 - TINY_BIT, 1.0)).unwrap(),
            ]).unwrap(),
        ).intersect(),
        IntersectionResult::Intersecting(vec![
            Intersection {
