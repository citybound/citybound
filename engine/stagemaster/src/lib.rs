...
pub fn setup(
    ...
    system.add(
        UserInterface::new(window.clone(), events_loop),
        move |mut the_ui| {
            ...
            the_ui.on_critical(move |_: &ProcessEvents, ui, world| {
                ...
                ui.events_loop.poll_events(|event| {
                    match event {
                        ...
                        Event::WindowEvent{ event: WindowEvent::MouseMoved { position: (x, y), .. }, ..} => {
                        ...
                        Event::WindowEvent{ event: WindowEvent::MouseInput { state: button_state, button: button, .. }, ..} => {
                        ...
                        Event::WindowEvent{ event: WindowEvent::ReceivedCharacter(c), ..} => ui.imgui.add_input_character(c),
                        _ => {}
                    }
                });
