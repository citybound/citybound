...
pub fn create() -> ::michelangelo::Mesh {
    ::michelangelo::Mesh::new(
        ...
        vec![
            // right side
            0, 1, 2, 0, 2, 5, 0, 5, 7, 5, 6, 7, 2, 3, 4, 2, 4, 5, // left side
            8, 9, 0xA, 8, 0xA, 0xD, 8, 0xD, 0xF, 0xD, 0xE, 0xF, 0xA, 0xB, 0xC, 0xA, 0xC, 0xD,
            // connection between sides (front to back)
            8, 9, 1, 8, 1, 0, 9, 0xA, 2, 9, 2, 1, 0xA, 0xB, 3, 0xA, 3, 2, 0xB, 0xC, 4, 0xB, 4, 3,
            0xC, 0xD, 5, 0xC, 5, 4, 0xD, 0xE, 6, 0xD, 6, 5, 0xE, 0xF, 7, 0xE, 7, 6u16,
        ],
    )
}
