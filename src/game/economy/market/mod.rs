...
use game::lanes_and_cars::pathfinding::{RoughDestination, RoughDestinationID,
                                        MSG_RoughDestination_query_as_destination,
                                        AsDestinationRequesterID,
...
use game::lanes_and_cars::pathfinding::{Destination, AsDestinationRequester, GetDistanceTo,
