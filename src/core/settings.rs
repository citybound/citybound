...
impl Settings{
    pub fn new() -> Settings{
        Settings{
            ...
            pitch_modifier_key: vec!{KeyOrButton::Key(VirtualKeyCode::K)} //vec![KeyOrButton::Button(MouseButton::Middle), KeyOrButton::Key(VirtualKeyCode::LAlt), KeyOrButton::Key(VirtualKeyCode::RAlt)],
        }
    }
