...
* Use well-known 1D acceleration and braking model and extend it to multi-lane behaviour
...
* Cars on switch lanes have more complex behaviour, reacting to cars on their left & right lanes and other cars merging between them.
    * Based on the perceived risk/required braking, merging cars can decide to abort their merge
